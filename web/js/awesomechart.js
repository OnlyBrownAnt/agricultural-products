...
function AwesomeChart(canvasElementId){
    ...
    this.chartPointFillStyle = '#3498db';
    
    this.chartLineStrokeStyle = '#3498db';
    this.chartLineWidth = 2;
    
    this.barFillStyle = '#33d9b2';
    this.barStrokeStyle = '#fff';
    this.barBorderWidth = 2.0;
    this.barShadowColor = '#33d9b2';
